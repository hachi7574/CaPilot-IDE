#!/usr/bin/env python3
"""Regenerate ui/components/Icon.tsx from ui/assets/icons/*.svg.
...
git.svg fill with the same variable. Run after adding/removing icons:
    ...
    python3 ui/scripts/gen_icon_component.py
"""
import os
import re
import json
...
OUT = os.path.join(os.path.dirname(__file__), "..", "components", "Icon.tsx")
BRAND_DIR = "brands"
...
def main() -> None:
    ...
    lines = [
        "// GENERATED FILE - do not edit by hand. Source: ui/assets/icons/*.svg",
        "// Regenerate: python3 ui/scripts/gen_icon_component.py",
